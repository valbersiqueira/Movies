...
import valber.com.br.movies.service.impl.JsonConverterLancamento;
import valber.com.br.movies.service.impl.JsonConverterMovies;
import valber.com.br.movies.utilsInteface.ServiceIntaface;

public class LancamentosMetodo implements ServiceIntaface {
    ...
    @Override
    public Call<Lancamentos> getMetodo() {
        Gson gson = new GsonBuilder()
                .registerTypeAdapter(Lancamentos.class, new JsonConverterLancamento())
                .create();
        ...
        return service.getLancamentos(apiKey, page, language);
    }
